...
class Task
{
    ...
    public function getNextStatus(string $action): string
    {
        return match ($action) {
            ...
            default => throw new nonExistAction('Данное действие не предусмотрено'),
        };
    }
    ...
    public function getAvailableActions(int $id): array
    {
        switch ($this->current_status) {
            ...
            default:
                throw new nonExistStatus('Статус не существует');
        }
    }
    ...
    public function actionAccept(int $id): void
    {
        if (in_array(ActionAccept::class, $this->getAvailableActions($id))) {
            ...
            throw new ActionUnavailable('Совершить данное действие невозможно');
        }
    }
